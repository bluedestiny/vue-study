      ...
      <el-form :model="ruleForm" class="demo-ruleForm" :rules="rules" ref="ruleForm" label-position="top">
        ...
        <el-form-item label="" prop="fenLei">
          ...
          <el-row style="height: 35px;" type="flex" align="middle">
            ...
            <el-col  class="" :span="2">
              <el-button type="text" @click="dialogFormFenLeiVisible = true" style="margin: 0;padding: 0;">设置</el-button>
            </el-col>
          </el-row>
        ...
        <el-form-item label="活动标签" required>
          ...
          <el-button icon="plus" size="large" @click.native="showDialog" style="vertical-align: middle;margin: 10px;">添加</el-button>
